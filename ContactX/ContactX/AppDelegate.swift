...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Getting Contacts List View module
        let contactsList = ListRouter.createModule()
        
        // Instantiating instance of UINavigationController with Contacts List View module
        let contactsNav = UINavigationController()
        contactsNav.viewControllers = [contactsList]
        
        window = UIWindow(frame: UIScreen.main.bounds)
        window?.rootViewController = contactsNav
